  ...
  class Program
  {
    ...
    private static void InsertActivity()
    {
      ...
      using (var context = new BreakAwayContext())
      {
        ...
        {
          Console.WriteLine("Save Test Failed: " + ex.EntityValidationErrors.FirstOrDefault().ValidationErrors.First().ErrorMessage);
        }
      }
    }
...
{
  using (var context = new TripPlanningContext())
  {
