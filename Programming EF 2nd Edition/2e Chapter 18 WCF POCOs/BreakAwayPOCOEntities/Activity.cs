    			...
    			set
     				{
    					if (value != null && value.Length > 100) 
    					 {throw new InvalidOperationException("imagepath must be less than 100 characters");}
    			    else
      				{ _imagepath = value;}
    				}
        ...
        public string Category
        {
    		   get{return _category;} 
    			set
     				{
    					if (value != null && value.Length > 50) 
    					 {throw new InvalidOperationException("Category must be less than 50 characters");}
    			    else
      				{ _category = value;}
    				}
